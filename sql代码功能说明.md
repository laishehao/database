...
老师可以开设多门课，一门课只能由一个老师来教；学生可以选修多门课，一门课也可以有多个学生选修，老师可以为自己的某一门课程发布多个作业，这个作业需要选修了这门课的所有学生去完成（每个学生的作答情况对应一个Write条目）。
...
信息维护：姓名、邮箱、手机、专业、性别、头像、密码

教师注册/登录/信息管理，功能与学生类似，但无“专业”字段

#### **2. 课程管理模块**
课程创建：课程名、专业、学分、类型（必修/选修）、授课教师

课程编辑/删除/查看

学生选课：学生可以选择课程

教师管理课程下的学生：可将学生从课程中删除
